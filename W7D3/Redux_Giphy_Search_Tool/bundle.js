...
exports.receiveSearchGiphys = exports.fetchSearchGiphys = exports.RECEIVE_SEARCH_GIPHYS = exports.REQUEST_SEARCH_GIPHYS = undefined;
...
function GiphysIndex(_ref) {
  ...
  var giphysList = giphys.map(function (giphy) {
...
var GiphysSearch = function (_React$Component) {
  ...
  function GiphysSearch() {
    ...
    _this.state = { searchTerm: 'teddy bear' };
